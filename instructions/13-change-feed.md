...
1. Aktualisieren Sie die vorhandene Variable mit dem Namen **key**, wobei ihr Wert auf den **Schlüssel** des zuvor erstellten Azure Cosmos DB-Kontos festgelegt ist.
