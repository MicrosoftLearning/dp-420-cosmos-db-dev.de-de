...
1. Starten Sie **Visual Studio Code**.
    ...
    > &#128221; Wenn Sie noch nicht mit der Visual Studio Code-Schnittstelle vertraut sind, lesen Sie die [Dokumentation „Erste Schritte“ für Visual Studio Code][code.visualstudio.com/docs/getstarted].
...
1. Wählen Sie in der Befehlsleiste **Speichern** aus, um das JSON-Element hinzuzufügen:
...
1. Sehen Sie sich die Klasse **Product** und die entsprechenden Eigenschaften an. Insbesondere verwendet dieses Lab die Eigenschaften **id**, **name** und **categoryId**.
...
1. Suchen Sie die **Zeichenfolgenvariable** mit dem Namen **endpoint**. Legen Sie ihren Wert auf den **Endpunkt** des zuvor erstellten Azure Cosmos DB-Kontos fest.
  
    ```
    string endpoint = "<cosmos-endpoint>";
    ```

    > &#128221; Wenn Ihr Endpunkt beispielsweise lautet: **https&shy;://dp420.documents.azure.com:443/**, dann lautet die C#-Anweisung: **string endpoint = "https&shy;://dp420.documents.azure.com:443/";**.

1. Suchen Sie die **Zeichenfolgenvariable** mit dem Namen **key**. Legen Sie ihren Wert auf den **Schlüssel** des zuvor erstellten Azure Cosmos DB-Kontos fest.
...
1. Kehren Sie zur Editorregisterkarte für die Codedatei **script.cs** zurück.
